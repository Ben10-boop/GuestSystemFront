...
import { Box, Typography, Stack, Table, TableContainer, TableRow, TableCell, TableBody, TableHead, Paper } from "@mui/material";
...
const Home = () => {
  ...
  return (
    <Box>
      ...
      >
        <Typography variant="h5">Active guests by forms</Typography>
        <TableContainer
          component={Paper}
          elevation={6}
          sx={{
      ...
      >
        <Typography variant="h5">Active guests by wifi status</Typography>
        <TableContainer
          component={Paper}
          elevation={6}
          sx={{
        ...
        >
          <Table size="small" aria-label="a dense table">
            <TableHead>
              <TableRow>
                <TableCell>Guest name</TableCell>
                <TableCell>Person being visited</TableCell>
                <TableCell>Wifi status</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
